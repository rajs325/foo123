...
function fetch(term) {
  ...
  request.open('GET', 'https://x9lx3yf7sr:h3yas5ptyy@newsobotics-4731548659.us-east-1.bonsaisearch.net:443/news/_search?q='+term+'&sort=_seq_no&from=0&size=300', true);
